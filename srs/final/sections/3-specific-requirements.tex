...
\begin{table}[H]
  ...
  \resizebox{\linewidth}{!}{%
    \begin{tabular}{|p{.3\linewidth}|p{.7\linewidth}|}
      ...
      \textbf{Use Case ID} & \theuseCaseID \\
      \hline
      \textbf{Use-Case Name} & Search for general needs \\
      \hline
      \textbf{Actors} & Victims or Volunteer \\
      \hline
      \textbf{Description} & Whenever a site user wants to display a one of the elements in general needs resource, he or she can view verified and updated related lists, which he or she can acquire necessary information. \\
      \hline
      \textbf{Data} & Verified and updated table of general needs such as gathering places, transportation aid and modile toilets. \\
      \hline
...
\begin{table}[H]
  ...
  \resizebox{\linewidth}{!}{%
    \begin{tabular}{|p{.3\linewidth}|p{.7\linewidth}|}
      ...
      \textbf{Use Case ID} & \theuseCaseID \\
      \hline
      \textbf{Use-Case Name} & Search for healthcare \\
      \hline
      \textbf{Actors} & Victims or Volunteer \\
      \hline
      \textbf{Description} & Whenever a site user wants to display a one of the elements in health services, he or she can view verified and updated related lists, which he or she can acquire necessary information. \\
      \hline
      \textbf{Data} & Verified and updated table of health services such as active hospitals, container pharmacies, and veterinarians. \\
      \hline
      \textbf{Preconditions} & The directory must be updated and verified regularly for potential update on the information. \\
      \hline
